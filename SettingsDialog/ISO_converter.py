...
data = [
    ...
    {
        "English": "Chinese Simplified Vertical",
        "alpha2": "",
        "alpha3-b": "chi_sim_vert"
    },
    {
    ...
    {
        "English": "Chinese Traditional Vertical",
        "alpha2": "",
        "alpha3-b": "chi_tra_vert"
    },
    {
...
ISO_639_3 = {i["alpha3-b"]: i["English"] for i in data}
ISO_639_2 = {i["alpha2"]: i["English"] for i in data}
ENGLISH_3 = {i["English"]: i["alpha3-b"] for i in data}
ENGLISH_2 = {i["English"]: i["alpha2"] for i in data}
ISO_2_TO_3 = {i["alpha2"]: i["alpha3-b"] for i in data}
ISO_3_TO_2 = {i["alpha3-b"]: i["alpha2"] for i in data}
TESSERACT_CODES = []
directory = '...'
while (not TESSERACT_CODES) and directory:
    directory = directory[:-1]
    TESSERACT_CODES = list(map(lambda path: os.path.splitext(os.path.basename(path))[0],
                               glob(directory + r'\tesseract2\tessdata\*.traineddata')))
